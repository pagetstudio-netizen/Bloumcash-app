...
- [WhatsApp provider webhook](convessa-webhook-url.md) — keep the existing callback URL while changing providers; browser GET/API unknown paths must not fall through to the SPA.
