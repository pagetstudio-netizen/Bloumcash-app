 ...
 */
/* GET — PayDunya vérifie l'accessibilité du callback avant de créer l'invoice */
router.get("/paydunya/webhook", (_req, res) => { res.json({ ok: true }); });
router.get("/paydunya/disburse-webhook", (_req, res) => { res.json({ ok: true }); });
