  ...
  return (
    <div className={BG}>
      ...
      <div className="flex items-center px-4 pt-4 pb-3 flex-shrink-0">
        ...
        <h1 className="text-base font-bold text-white flex-1 text-center pr-7">Configuration TMoney</h1>
      </div>
      ...
      <div className="flex-1 flex flex-col px-4 pb-5 gap-4 overflow-y-auto">
        ...
        >
          <img src={tmoneyLogo} alt="TMoney" className="w-14 h-14 rounded-2xl object-cover flex-shrink-0" />
          <div>
            <h2 className="font-bold text-gray-900 text-base">TMoney</h2>
            <p className="text-xs text-gray-500 mt-0.5">Togocel — Togo</p>
            {saved && (
        ...
        >
          <p className="text-white/80 text-xs leading-relaxed">
            Ce numéro sera utilisé pour recevoir les paiements TMoney. Assurez-vous qu'il est actif et accessible.
          </p>
        </motion.div>
