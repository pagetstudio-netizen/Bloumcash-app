...
export const whatsappConversationsTable = pgTable("whatsapp_conversations", {
  ...
  transferRecipientOperator: text("transfer_recipient_operator"),
  transferRecipientPhone: text("transfer_recipient_phone"),
  transferSenderOperator: text("transfer_sender_operator"),
